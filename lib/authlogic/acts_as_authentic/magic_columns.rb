      ...
      module Methods
        def self.included(klass)
          klass.class_eval do
            ...
            validates_is_number :login_count, :integer_only => :true if property_names.include?(:login_count)
            validates_is_number :failed_login_count, :integer_only => :true if property_names.include?(:failed_login_count)
          end
        end
      end
    end
